    ...
    <div className="profile-dropdown" ref={dropdownRef}>
      <div className="profile-dropdown__header">
        ...
        <div className="profile-dropdown__info">
          ...
          <p className="profile-dropdown__email">{user?.email || 'No email'}</p>
        </div>
      </div>
      ...
      <div className="profile-dropdown__menu">
        ...
        >
          <div className="profile-dropdown__menu-icon">
            <svg
              width="20"
              height="20"
              viewBox="0 0 20 20"
        ...
        >
          <div className="profile-dropdown__menu-icon profile-dropdown__menu-icon--logout">
            <svg
              width="20"
              height="20"
              viewBox="0 0 20 20"
          ...
          <span className="profile-dropdown__menu-text">Выйти из аккаунта</span>
          <div className="profile-dropdown__menu-chevron">›</div>
        </button>
      </div>
    </div>
