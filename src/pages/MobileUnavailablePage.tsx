import "@/styles/mobile-unavailable.css";

const MobileUnavailablePage = () => {
  return (
    <div className="mobile-unavailable">
      <div className="mobile-unavailable__inner">
        <div className="mobile-unavailable__icon" aria-hidden="true">
        ...
        <h1 className="mobile-unavailable__title">
          Мобильная версия в разработке
        </h1>

        <p className="mobile-unavailable__text">
          Пока Inspiro доступен только на десктопе. Откройте сайт с&nbsp;компьютера,
          чтобы пользоваться всеми возможностями. Мобильная версия скоро&nbsp;появится.
        </p>
      </div>
    </div>
  );
